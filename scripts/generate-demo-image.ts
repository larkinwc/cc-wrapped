...
import type { ClaudeCodeStats } from "../src/types";
import { join } from "node:path";

// Generate realistic sample data
function generateDemoStats(): ClaudeCodeStats {
  const year = 2025;
  ...
  return {
    ...
    totalCacheReadTokens: 18_400_000,
    totalCacheWriteTokens: 6_200_000,
    cacheHitRate: 74.8,
    totalWebSearchRequests: 132,
    totalToolCalls: 4812,
    peakContextWindow: 200_000,
